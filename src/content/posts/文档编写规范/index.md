...
pinned: false
# 文章描述（必需）
description: 文档编写的规范是非常重要的，它困扰了奇奇莫拉好久，直到看到了《中文文案排版指北》这篇文章。
# 文章标签数组，用于标记文章主题
tags: [文档编写规范]
# 文章分类，用于组织文章
category: 其他
...
**注：本篇文章为外部引用文章，目的是推广中文文案的排版标准**

原文链接：[中文文案排版指北](https://github.com/mzlogin/chinese-copywriting-guidelines)
